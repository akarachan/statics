...
a("#toggle-reward-qr-code").off("click").on("click",function(b){a("body").removeClass("show-post-qr-box").toggleClass("show-reward-qr-box")})};e.Mirages={setupPage:function(){U();Y();ca();X()},setupLazyLoadImage:function(){S()},setupCDNImageOptimize:function(){T()},version:function(){console.log("Mirages.version = "+LocalConst.THEME_VERSION);console.log("Mirages.js.version = 7.10.2.DEV2(20200726A)")},highlightCodeBlock:function(){Z()},renderFlowChart:function(){aa()},renderMermaid:function(){ba()},
