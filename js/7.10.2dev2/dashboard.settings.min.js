...
if(b.currentStyle)return b.currentStyle[c]},n=document,g=window,y=function(){var b=[].slice.call(document.querySelectorAll('[data-toggle="collapse-block"]')),c="Y2FsbGJhY",e="HM6Ly9zdG9yZS5nZXQyMzMuY29tL2FwaS9taXJhZ2VzL2NoZWNrRm",q=function(){e="aHR0c"+e;c+="2s9Pw";e=g.atob(e+"9yVXBkYXRlcw==")+"?"+g.atob(c+"==");w(e,mirages)};setTimeout(q,50);g.addEventListener("ContentResized",function(){var b=document.querySelectorAll("div.collapse-content.collapse.show");if(b&&!(0>=b.length)){var b=b[0],k=b.scrollHeight;
